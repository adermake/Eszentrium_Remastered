...
public class Heldenstoß extends Spell {
	...
	public Heldenstoß() {
		...
		setLore("§7Der Spieler fliegt in Blickrichtung#§7voran. Nach kurzer Zeit oder bei Bodenkontakt#§7entsteht eine Explosion, die Gegnern#§7schadet und siewegschleudert. Je länger der#§7Zauber angehalten hat, desto stärker ist dieser#§7Effekt.");
	}
