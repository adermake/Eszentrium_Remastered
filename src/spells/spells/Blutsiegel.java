...
public class Blutsiegel extends Spell {
	...
	public Blutsiegel() {
		...
		setLore("�7Beschw�rt ein Pentagramm auf dem Boden#�7in Blickrichtung. Gegner, die sich auf dem#�7Pentagramm befinden, erhalten einmalig#�7Schaden.Au�erdem wird der Anwender um den#�7Schaden geheilt, den ein Gegner in diesem Feld#�7erleidet.");
	}
	@Override
	public void setUp() {
