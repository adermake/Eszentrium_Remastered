...
public class Machtwort extends Spell {
    ...
    public void move() {
        ...
        if (step % 60 == 0 && refined) {
            ...
            ParUtils.parKreisDot(Particle.TOTEM_OF_UNDYING, loc, 1, 1, 1, new Vector(0, 1, 0));
        }
    }
    ...
    public void display() {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            ParUtils.createFlyingParticle(Particle.LARGE_SMOKE, l, 0, 0, 0, 1, 0, new Vector(0, 1, 0));
            ParUtils.createFlyingParticle(Particle.TOTEM_OF_UNDYING, l, 0, 0, 0, 1, 1, new Vector(0, 0.7F, 0));
    ...
    public void onPlayerHit(Player p) {
        //p.damage(0.5F);
        ParUtils.createParticle(Particle.ENCHANT, p.getLocation().add(0, -1, 0), 1, 0, 1, 8, 1);
        // TODO Auto-generated method stub
        tickCooldown(15, p);
