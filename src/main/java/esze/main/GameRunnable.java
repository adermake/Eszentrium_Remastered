...
public class GameRunnable {
    ...
    public static void start() {
        runnableTickID = Bukkit.getScheduler().scheduleSyncRepeatingTask(main.plugin, () -> GameType.getType().runEveryTick(), 0, 1);
        runnableSecID = Bukkit.getScheduler().scheduleSyncRepeatingTask(main.plugin, () -> GameType.getType().runEverySecond(), 0, 20);
    }
